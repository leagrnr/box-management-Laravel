...
<x-app-layout>
    <x-slot name="header">
        {{ __('Création de facture') }}
    </x-slot>
    <body>
    <div class="flex flex-col items-center">
        <h1 class="text-white font-bold font-xl mb-5">Création de facture</h1>

        <hr>

        <form action="{{ route('bills.store') }}" method="POST" class="w-full max-w-sm">
            @csrf
            ...
            <div class="md:flex md:items-center mb-6">
                ...
                <div class="md:w-2/3">
                    <input type="number" name="payment_montant" id="payment_montant" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" value="{{ old('payment_montant') }}" required>
                </div>
            </div>
            ...
            <div class="md:flex md:items-center mb-6">
                ...
                <div class="md:w-2/3">
                    <input type="number" name="period_number" id="period_number" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" value="{{ old('period_number') }}" required>
                </div>
            </div>
